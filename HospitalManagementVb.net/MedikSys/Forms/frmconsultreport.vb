...
Imports System.Data
Public Class frmconsultreport
    Public strWhere As String
    Public strReport As String
    Private mReport As ReportDocument

    Private Sub frmconsultreport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case strReport
            Case "Filter"
                mReport.Load("..\Reports\CrystalReport2.rpt")
