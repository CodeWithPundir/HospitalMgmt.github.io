...
Imports System.Data
Public Class frmeyereport
    Public strWhere As String
    Public strReport As String
    Private mReport As ReportDocument
    Private Sub frmeyereport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case strReport
            Case "Filter"
                mReport.Load("..\Reports\crteye.rpt")
