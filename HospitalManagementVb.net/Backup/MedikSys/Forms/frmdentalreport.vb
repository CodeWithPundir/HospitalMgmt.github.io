...
Imports System.Data
Public Class frmdentalreport
    Public strWhere As String
    Public strReport As String
    Private mReport As ReportDocument
    Private Sub frmdentalreport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strReport
            Case "Filter"
                mReport.Load("..\Reports\Crtdental.rpt")
