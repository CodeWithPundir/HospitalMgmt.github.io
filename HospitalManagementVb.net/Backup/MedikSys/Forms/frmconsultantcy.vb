...
Public Class frmconsultantcy
    ...
    Public Sub FillDGV()
        ...
        DataAdapter1 = New OleDbDataAdapter("Select * From reg2", con)
        DataSet1.Clear()
        DataAdapter1.Fill(DataSet1, "reg2")
        dgv1.DataSource = DataSet1
        dgv1.DataMember = "reg2"
        Call Module2.refreshdgv()
    End Sub
    Public Sub sms()
        Dim sms As String
        sms = MsgBox("Record is not in the database", MsgBoxStyle.Critical, "Notification")

    End Sub
    Private Sub frmconsultantcy_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '=============================================================================================================
        Me.CenterToScreen()
        con.Open()
        Call FillDGV()
        'txtid.DataBindings.Add("Text", DataSet1, "reg2.patientid")
        'txtname.DataBindings.Add("Text", DataSet1, "reg2.First_name")
        'txtsur.DataBindings.Add("Text", DataSet1, "reg2.surname")
        'txthistory.DataBindings.Add("Text", DataSet1, "reg2.Medical_History")
        'txtdiagnoses.DataBindings.Add("Text", DataSet1, "reg2.diagnoses")
        'txtsympton.DataBindings.Add("Text", DataSet1, "reg2.sympton")
        'txttreatment.DataBindings.Add("Text", DataSet1, "reg2.treatment")
        'txtdoctor.DataBindings.Add("Text", DataSet1, "reg2.Doctor")
        'dtp.DataBindings.Add("Text", DataSet1, "reg2.date_date")
        Call Module2.refreshdgv()
        '============================================================================================================
    ...
    Private Sub btncofirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncofirm.Click
        ...
        If Not cboconfirm.Text = "patientid" Then
            btnsave.Enabled = False
            Call sms()
        ElseIf cboconfirm.Text = "patientid" Then
            Call Module2.confirmation()
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        Else
            ...
            sql = "SELECT * FROM reg2 WHERE patientid ='" & Trim(txtid.Text) & "'"
            Dim da As New OleDbDataAdapter(sql, con)
            Dim dt As New DataTable("reg2")
            da.Fill(dt)
            ...
            Else
                ...
                sqlinsert = "INSERT INTO reg2(patientid,First_name,surname,Age,Medical_history,diagnoses,sympton,treatment,Doctor,date_date)" & _
                "VALUES(@patientid,@First_name,@surname,@Age,@Medical_history,@diagnoses,@sympton,@treatment,@Doctor,@date_date)"
                ...
                cmd.Parameters.Add(New OleDbParameter("@Medical_history", txthistory.Text))
                cmd.Parameters.Add(New OleDbParameter("@diagnoses", txtdiagnoses.Text))
                cmd.Parameters.Add(New OleDbParameter("@sympton", txtsympton.Text))
    ...
    Private Sub btnedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnedit.Click
        ...
        If MsgBox("Are you sure you want to edit data, edited data will be updated in the database", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Notification") = MsgBoxResult.Yes Then
            ...
            sqlupdate = "UPDATE reg2 SET First_name ='" & txtname.Text & "', surname = '" & txtsur.Text & "',Age = '" & txtage.Text & "', Medical_history = '" & txthistory.Text & "', diagnoses = '" & txtdiagnoses.Text & "', sympton = '" & txtsympton.Text & "', treatment='" & txttreatment.Text & "', Doctor ='" & txtdoctor.Text & "',date_date='" & dtp.Text & "' WHERE patientid ='" & Integer.Parse(txtid.Text) & "'"
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        ...
        If MsgBox("Are you sure want to permanently delete user from database?", MsgBoxStyle.YesNo, "Warning") = MsgBoxResult.Yes Then
            sqldelete = "DELETE * FROM reg2 WHERE First_Name ='" & dgv1.CurrentRow.Cells(1).Value.ToString & "'"
            ' This is our DataAdapter. This executes our SQL Statement above against the Database
    ...
    Private Sub btnsearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsearch.Click
        ...
        If cbosearch.Text = "surname" Then
            Call Module2.autocompletSurname()
            DataAdapter1 = New OleDbDataAdapter("Select * From reg2 Where " & cbosearch.Text & " like '%" & Trim$(txtseacrh.Text) & "'", con)

        ElseIf cbosearch.Text = "patientid" Then
            Call Module2.autocompleteID()
            DataAdapter1 = New OleDbDataAdapter("Select * From reg2 Where " & cbosearch.Text & " like '%" & Trim$(txtseacrh.Text) & "'", con)

        ElseIf cbosearch.Text = "First_name" Then
            Call Module2.autocompletFirst_Name()
            DataAdapter1 = New OleDbDataAdapter("Select * From reg2 Where " & cbosearch.Text & " like '%" & Trim$(txtseacrh.Text) & "'", con)
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkPrintAll.CheckedChanged

    End Sub

    Private Sub btndone_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndone.Click
        With frmconsultreport

            If ChkPrintAll.Checked = False Then
                If txtname.Text = "" Then
                    MsgBox("Please select a patient record to be printed.", MsgBoxStyle.Critical)

                    Exit Sub
                End If
                .strReport = "Filter"

                .strWhere = " {reg2.patientid} = " & (txtid.Text).ToString
            Else
                .strReport = "Print All"
            End If

            frmconsultreport.ShowDialog()
        End With
    End Sub
